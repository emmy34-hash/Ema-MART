...
const INVENTORY_CATALOG = [
    ...
    { id: 1, title: "Women Luxury Evening Wrap", category: "Clothes", subCategory: "Women", price: 4200, discount: 15, img: "https://images.pexels.com/photos/2887864/pexels-photo-2887864.jpeg?auto=compress&cs=tinysrgb&w=500", desc: "Elegant designer evening wear tailored with breathable long-staple linen composites." },
    ...
    { id: 9, title: "Kids Knit Denim Overalls", category: "Clothes", subCategory: "Kids", price: 2400, discount: 12, img: "https://images.unsplash.com/photo-1519235115857-1f4cc4a9c288?auto=format&fit=crop&w=400&q=80", desc: "Flexible stretch-infused authentic cotton indigo washes engineered to minimize abrasions." },
    ...
    { id: 16, title: "Fast Wireless Charging Dock", category: "Electronics", subCategory: "Accessories", price: 3200, discount: 15, img: "https://images.unsplash.com/photo-1622445262465-2481c4574875?auto=format&fit=crop&w=400&q=80", desc: "Dual induction copper coils sending efficient magnetic field energy conversions safely." },
    ...
    { id: 31, title: "Pro Cast-Iron Non-Stick Skillet", category: "Household", subCategory: "Kitchen", price: 5400, discount: 12, img: "https://images.unsplash.com/photo-1599672675550-204960a22a41?auto=format&fit=crop&w=400&q=80", desc: "Pre-seasoned heavy iron ore distribution hulls retaining extreme cooking heat levels uniformly." },
    { id: 32, title: "Egyptian Luxury Towel Collection", category: "Household", subCategory: "Bathroom", price: 3800, discount: 0, img: "https://images.unsplash.com/photo-1616627451515-cbc80e5dee34?auto=format&fit=crop&w=400&q=80", desc: "Zero-twist long loops yielding high liquid absorbency speeds per cubic inch." },
    { id: 33, title: "Minimalist 16-Piece Ceramic Set", category: "Household", subCategory: "Dining", price: 9800, discount: 0, img: "https://images.unsplash.com/photo-1610701596007-11502861afaa?auto=format&fit=crop&w=400&q=80", desc: "High-temperature vitrified stone dish selections sporting pristine matte protective glaze shield lines." },
    ...
    { id: 39, title: "Automatic Espresso Brew Station", category: "Household", subCategory: "Kitchen", price: 34000, discount: 10, img: "https://images.unsplash.com/photo-1517914309062-8174415cf26d?auto=format&fit=crop&w=400&q=80", desc: "Integrated 15-bar mechanical pressure water injectors extracting rich aromatic crema layers." },
    ...
    { id: 45, title: "Premium Rose Quartz Face Roller", category: "Beauty", subCategory: "Makeups", price: 2200, discount: 0, img: "https://images.unsplash.com/photo-1608248597481-496100c80836?auto=format&fit=crop&w=400&q=80", desc: "Natural cooling gemstone heads massaging tissue profiles to encourage lymphatic drainage." },
    ...
    { id: 49, title: "Articulated Retro Action Figure", category: "Toys", subCategory: "Kids", price: 2700, discount: 10, img: "https://images.unsplash.com/photo-1608889174633-41443632221c?auto=format&fit=crop&w=400&q=80", desc: "32 points of detailed mechanical skeletal joint manipulation metrics for custom desktop display posing." },
